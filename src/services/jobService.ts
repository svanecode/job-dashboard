...
export async function getJobsByScore(score: number, params?: JobFilters): Promise<{ data: Job[]; total: number; page: number; pageSize: number; totalPages: number }> {
  if (!supabase) {
    throw new Error('Supabase client not initialized');
  }
...
export async function getJobsByLocation(location: string, params?: JobFilters): Promise<{ data: Job[]; total: number; page: number; pageSize: number; totalPages: number }> {
  if (!supabase) {
    throw new Error('Supabase client not initialized');
  }
...
export async function getJobsByDate(daysAgo: number, params?: JobFilters): Promise<{ data: Job[]; total: number; page: number; pageSize: number; totalPages: number }> {
  if (!supabase) {
    throw new Error('Supabase client not initialized');
  }
...
export async function getHighPriorityJobs(params?: JobFilters): Promise<{ data: Job[]; total: number; page: number; pageSize: number; totalPages: number }> {
  if (!supabase) {
    throw new Error('Supabase client not initialized');
  }
